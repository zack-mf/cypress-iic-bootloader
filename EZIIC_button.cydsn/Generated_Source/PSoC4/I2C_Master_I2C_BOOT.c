...
*
* \globalvars
*  I2C_Master_applyBuffer - the flag to release the buffer with a response
...
*
* \globalvars
*  I2C_Master_slRdBufSize - used to store slave read buffer size.
*  I2C_Master_slRdBufIndex - used to store the current index within the
*  slave read buffer.
            ...
            if (0u != (I2C_Master_I2C_SSTAT_WR_CMPLT & I2C_Master_slStatus))
            {
                ...
                *count = (uint16) I2C_Master_slWrBufIndex;
                ...
                (void) memcpy((void *) pData, (const void *) I2C_Master_slWriteBuf,
                                              I2C_Master_BYTES_TO_COPY(*count, size));
...
*
* \globalvars
*  I2C_Master_applyBuffer - the flag to release the buffer with
*  to be read by the host.
*
*******************************************************************************/
...
static void I2C_Master_I2CResposeInsert(void)
{
    if (I2C_Master_CHECK_INTR_SLAVE_MASKED(I2C_Master_INTR_SLAVE_I2C_ADDR_MATCH))
    {
        ...
        else
        {
            ...
            {
                I2C_Master_slRdBufIndex = I2C_Master_slRdBufSize;
            }
        }
    }
}
