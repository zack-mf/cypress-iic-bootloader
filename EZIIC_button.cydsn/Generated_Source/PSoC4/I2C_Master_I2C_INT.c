...
#ifdef I2C_Master_I2C_ISR_ENTRY_CALLBACK
    I2C_Master_I2C_ISR_EntryCallback();
#endif /* I2C_Master_I2C_ISR_ENTRY_CALLBACK */

#if (I2C_Master_I2C_CUSTOM_ADDRESS_HANDLER_CONST)
    uint32 response;

    response = I2C_Master_I2C_ACK_ADDR;
    ...
    else if(I2C_Master_CHECK_I2C_FSM_SLAVE)
    {
        #if(I2C_Master_I2C_SLAVE)
        {
            ...
            */
            ...
            #ifdef I2C_Master_I2C_SLAVE_CMPLT_CALLBACK
                /* Read complete */
                I2C_Master_I2C_SlaveCompleteCallback();
            #endif /* I2C_Master_I2C_SLAVE_CMPLT_CALLBACK */
            }
            ...
            */
        ...
        #endif /* (I2C_Master_I2C_CUSTOM_ADDRESS_HANDLER_CONST) */
            {
                ...
                #if (I2C_Master_I2C_CUSTOM_ADDRESS_HANDLER)
                {
                    if (NULL != I2C_Master_customAddressHandler)
                    {
                        /* Call custom address handler */
                        response = I2C_Master_customAddressHandler();
                    }
                    else
                    {
                        /* Read address from the RX FIFO. If there is no address underflow triggers but
                        * component does not use that source. */
                        (void) I2C_Master_RX_FIFO_RD_REG;
                        response = I2C_Master_I2C_ACK_ADDR;
                    }
            ...
            #if (I2C_Master_I2C_CUSTOM_ADDRESS_HANDLER_CONST)
                if (response == I2C_Master_I2C_NAK_ADDR)
                {
                #if (!I2C_Master_CY_SCBIP_V0)
                    /* Disable write stop interrupt source as it triggers after address was NACKed. Ticket ID#156094 */
                    I2C_Master_DISABLE_INTR_SLAVE(I2C_Master_INTR_SLAVE_I2C_WRITE_STOP);
                #endif /* (!I2C_Master_CY_SCBIP_V0) */
            ...
            #endif /* (I2C_Master_I2C_CUSTOM_ADDRESS_HANDLER_CONST) */
                {
                    ...
                    I2C_Master_ENABLE_INTR_SLAVE(I2C_Master_INTR_SLAVE_I2C_WRITE_STOP);
                #endif /* (!I2C_Master_CY_SCBIP_V0) */
                ...
                while(I2C_Master_I2C_FIFO_SIZE != I2C_Master_GET_TX_FIFO_ENTRIES)
                {
                    ...
                    */
                    ...
                    /* Probably Overflow */
                    {
                        ...
                        if(I2C_Master_slOverFlowCount <= I2C_Master_I2C_TX_OVERFLOW_COUNT)
                        {
...
#ifdef I2C_Master_I2C_ISR_EXIT_CALLBACK
    I2C_Master_I2C_ISR_ExitCallback();
#endif /* I2C_Master_I2C_ISR_EXIT_CALLBACK */
