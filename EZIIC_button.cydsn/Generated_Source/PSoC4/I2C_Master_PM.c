...
****************************************************************************//**
*
*  Prepares the I2C_Master component to enter Deep Sleep.
...
*    disabling.
*
*  Call the I2C_Master_Sleep() function before calling the 
...
****************************************************************************//**
*
*  Prepares the I2C_Master component for Active mode operation after 
*  Deep Sleep.
...
*
*  \sideeffect
*   Calling the I2C_Master_Wakeup() function without first calling the 
*   I2C_Master_Sleep() function may produce unexpected behavior.
*
*******************************************************************************/
