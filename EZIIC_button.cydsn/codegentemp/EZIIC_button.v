// ======================================================================
// EZIIC_button.v generated from TopDesign.cysch
// 05/25/2020 at 16:32
...
// IDAC_P4_v1_10(IDACRange=0, IDACValue=120, Polarity=1, Resolution=7, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONFIG_TITLE=IDACComp, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=CapSense:IDACComp, CY_INSTANCE_SHORT_NAME=IDACComp, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=true, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=CapSense_IDACComp, )
...
module CapSense_P4_v7_0_3 ;
	...
	cy_clock_v1_0
		#(.id("f27b74c6-e8a9-4c1b-a2f7-8fc41a51ba4f/a8285cdc-5e81-40c0-8036-58ea5f8c1102"),
	...
	cy_clock_v1_0
		#(.id("f27b74c6-e8a9-4c1b-a2f7-8fc41a51ba4f/dc05f2b0-a67b-4bab-aef2-0d210293eadb"),
		  .source_clock_id("413DE2EF-D9F2-4233-A808-DFAF137FD877"),
		  .divisor(255),
		  .period("0"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f27b74c6-e8a9-4c1b-a2f7-8fc41a51ba4f/67bbdae9-6d7f-4909-bd9b-ee2616c651c8"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f27b74c6-e8a9-4c1b-a2f7-8fc41a51ba4f/7611adc0-783c-42ac-866a-acd65d57cdc4"),
		  .drive_mode(12'b000_000_000_000),
		  .ibuf_enabled(4'b0_0_0_0),
		  .init_dr_st(4'b0_1_1_1),
		  .input_clk_en(0),
		  ...
		  .pa_out_clock_en(-1),
		  .pa_out_reset(-1),
		  .pin_aliases("UP_Sns0,DOWN_Sns0,LEFT_Sns0,RIGHT_Sns0"),
		  .pin_mode("AAAA"),
		  .por_state(4),
		  .sio_group_cnt(0),
		  .sio_hyst(4'b1_1_1_1),
	...
	cy_psoc3_pins_v1_10
		#(.id("f27b74c6-e8a9-4c1b-a2f7-8fc41a51ba4f/4e4fc427-17cf-4112-acbc-200ba24a3ac0"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
